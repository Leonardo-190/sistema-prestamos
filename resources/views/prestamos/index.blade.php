    ...
    <div class="main-content" id="mainContent">
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="{{ route('prestamos.index') }}" class="active" data-section="prestamos">
        ...
        <div class="content">
            <div class="page-header">
                ...
                <p>Administra todos los préstamos de equipos</p>
            </div>
            ...
            <div class="section">
                ...
                <table class="table table-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $prestamo->equipo_id ?? 'N/A' }}</td>
                            <td>{{ $prestamo->alumno_id ?? 'N/A' }}</td>
                            <td>{{ $prestamo->fecha_prestamo ?? 'N/A' }}</td>
                            <td>{{ $prestamo->fecha_devolucion ?? 'N/A' }}</td>
                            <td>
                                <span class="badge {{ $prestamo->estado == 'activo' ? 'badge-success' : 'badge-warning' }}">
                                    {{ ucfirst($prestamo->estado ?? 'indefinido') }}
                                </span>
                            </td>
                        </tr>
                        @empty
