...
<a href="{{ route('dashboard') }}" class="active" data-section="dashboard">
...
<td><i class="fas fa-laptop"></i> Laptop HP</td>
...
<td><i class="fas fa-keyboard"></i> Teclado Mecánico</td>
...
<td><i class="fas fa-mouse"></i> Mouse Logitech</td>
...
<td><span class="badge badge-warning">Retrasado</span></td>
...
<td><i class="fas fa-monitor"></i> Monitor Samsung 24"</td>
...
<td><i class="fas fa-laptop"></i> Laptop Dell</td>
...
<td><i class="fas fa-headphones"></i> Audífonos JBL</td>

<td>No funciona audio derecho</td>
